...
@Component({
  selector: 'app-buscarporpro',
  templateUrl: './buscarporpro.page.html',
  styleUrls: ['./buscarporpro.page.scss'],
})
export class BuscarporproPage implements OnInit {
idSelected:any;
  datosagenda = []; 
  ...
  constructor(public navCtrl: NavController,
   public datos: FbserviceService) {  this.show = false; 
    this.idSelected = 0; 
